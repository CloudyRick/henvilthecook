    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(30,30,30,0.4)", backdropFilter: "blur(4px)" }}>
      ...
      >
        <div className="mb-8 flex items-center justify-between">
          ...
          <button onClick={onClose} className="link-muted">
        ...
        <button
          ...
          className="btn-outline flex w-full items-center justify-center gap-3 rounded-full py-3 text-sm font-semibold tracking-wide"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="auth-input block w-full rounded-lg px-4 py-3 text-sm outline-none"
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-primary w-full rounded-full py-3 text-sm font-semibold tracking-wide disabled:opacity-50"
          >
